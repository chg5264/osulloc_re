			...
			<div class="bc_container">
				...
				<%-- <div class="bcc_header">
					...
					<div class="bcc_header">
						...
						<div id="bcc_nameNwatch">
							<p class="nickname">작성자 <span id="nickname">${detail.writer}</span></p>&nbsp;&nbsp;
							<p class="watch"> 조회수  <span id="watch">${detail.cnt}</span></p>
						</div>
				...
				<div class="board_btn">
					...
					<a href="/osulloc/page/modify?bno=${detail.bno}" class="b_btn">수정</a> 
					<a href="/osulloc/page/remove?bno=${detail.bno}" class="b_btn">삭제</a>
				</div>
				<!--본문_본문_푸터-->
			</div>
			<!--본문_본문-->
