	...
	<div class="wrap">
		<div class="container">
			...
			<form action="/osulloc/page/reviewModify" method="post" role="form">
				...
				<input type="hidden" name="writer" value="${login.id}"> <input
					type="hidden" name="pno" value="${pno}">
				<div>
					<div>
						<input type="text" name="title" class="title"
							placeholder="제목을 입력해 주세요" value="${productreview[0].title}">
					</div>
					<div>
						<textarea rows="30" cols="20" name="content" class="content"
							placeholder="내용을 입력하세요">${productreview[0].content}</textarea>
					</div>
				</div>
				<div class="writeBtn">
